...
<body>
		...
		<nav id="navb"class="navbar navbar-expand-lg navbar-light bg-dark">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
						<a href="rent1.jsp"class="nav-link text-light">Rent</a>
						...
						<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
									...
									<a href="logpage.jsp"class="dropdown-item" href="#">Logout</a>
								</div>
						</li>
					</ul>
			</div>
	...
	try{
		...
		while(rs.next())
		{
			...
			out.println("</form>");
			out.println("<form  action='order.jsp' method='post' id='myTabContent'>");
			out.println("<input name='studioname' type='hidden' class='text-left clear' readonly value='"+rs.getString("studioname")+"'/><br>");
			out.println("<input type='submit' class='btn btn-primary' value='BOOKNOW'/>");
			out.println("</div>");
			out.println("</div>");
			out.println("</div>");
			out.println("</form>");
			...
			else if(count==1)
			{
				out.println("<form  action='photographerprofile.jsp' method='post' class='tab-content' id='myTabContent'>");
					...
					out.println("<div class='card-body'>");
					out.println("<input name='studioname'  class='text-left clear' readonly value='"+rs.getString("studioname")+"'/><br>");
					//ses.setAttribute("studioname",rs.getString("studioname"));
					out.println("<div class='dropdown-divider'></div>");
					out.println("<div class='card-text'>");
					out.println("<input name='firstname'  class='text-center clear' readonly value='"+rs.getString("firstname")+"'/><br>");
					out.println("<input name='address1'  class='text-center clear' readonly  value='"+rs.getString("address1")+"'/><br>");
			...
			else if(count==3)
			{
				out.println("<form  action='photographerprofile.jsp' method='post' class='tab-content' id='myTabContent'>");
					...
					out.println("<input type='submit' class='btn btn-primary' value='VIEW'/>");
					out.println("</form>");
					out.println("<form  action='order.jsp' method='post' id='myTabContent2'>");
					out.println("<input name='studioname' type='hidden' class='text-left clear' readonly value='"+rs.getString("studioname")+"'/><br>");
					out.println("<input type='submit' class='btn btn-primary' value='BOOKNOW'/>");
					out.println("</div>");
					out.println("</div>");
